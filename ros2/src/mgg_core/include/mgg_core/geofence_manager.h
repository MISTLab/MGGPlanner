// Keep-out zones the planner must not route through.
//
// Ported from planner_common/geofence_manager.h. The geometry is Boost.Geometry
// and was already ROS-free; what is left behind is the geometry_msgs::Polygon
// constructor and overload (conversion belongs in mgg_ros) and loadParams.

#ifndef MGG_CORE_GEOFENCE_MANAGER_H_
#define MGG_CORE_GEOFENCE_MANAGER_H_
...
#endif  // MGG_CORE_GEOFENCE_MANAGER_H_
